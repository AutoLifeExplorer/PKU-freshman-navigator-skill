#!/usr/bin/env python3
"""Check the small set of public source entry points used by live smoke tests."""
...
def check(name: str, url: str) -> dict[str, object]:
    request = urllib.request.Request(url, headers={"User-Agent": "pku-freshman-navigator-source-check/1.0"})
